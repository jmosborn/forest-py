        ...
        if args.total:
                ...
                for reservation in response['Reservations']:
                        for instance in reservation['Instances']:
                                if args.verbose:
                                  our_values = [instance['InstanceId'], instance['InstanceType'], instance['Placement']['AvailabilityZone'], instance['SubnetId'], instance['VpcId'], instance['State']['Name'], instance['PrivateIpAddress'], json.dumps(instance['Tags'])]
                                else:
